...
UserInterface::UserInterface(const SystemHandlers& systemHandlers, const Camera& camera)
	: _systemHandlers(systemHandlers), _camera(camera), _inputLayout(nullptr), _vertexShader(nullptr),
