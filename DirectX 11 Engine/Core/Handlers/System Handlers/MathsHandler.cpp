...
XMFLOAT3 MathsHandler::CalculateTangent(TempVertex v1, TempVertex v2, TempVertex v3)
{
	...
	tuVector = XMFLOAT2(v2.TexCoord.x - v1.TexCoord.x, v3.TexCoord.x - v1.TexCoord.x);
	tvVector = XMFLOAT2(v2.TexCoord.y - v1.TexCoord.y, v3.TexCoord.y - v1.TexCoord.y);
...
float MathsHandler::Magnitude(const XMFLOAT3& inVec)
{
